<template>
    <div>
        <div class="bg-white-900 h-screen py-8">
                                    ...
                                    <tr>
                                        <td class="py-4">
                                            <div class="flex items-center">
                                                ...
                                                <span class="font-semibold"> Belanaja </span>
                                            </div>
                                        </td>
                                        <td class="py-4">19.99</td>
                                        <td class="py-4">
                                            <div class="flex items-center">
                                                <button class="border rounded-md py-2 px-4 mr-2" v-on:click="kurang">-</button>
                                                <span class="text-center w-8">{{counter}}</span>
                                                <button class="border rounded-md py-2 px-4 ml-2" v-on:click="tambah">+</button>
                                            </div>
                                        </td>
                                        <td class="py-4">19.99</td>
                                    </tr>
